...
RUN gem install appium_lib ci_reporter cucumber selenium rspec addressable win32-service selenium-cucumber clipboard syntax google-api-client mechanize
