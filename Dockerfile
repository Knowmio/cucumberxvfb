...
RUN gem install selenium-webdriver ci_reporter cucumber selenium rspec addressable win32-service selenium-cucumber clipboard syntax google-api-client mechanize --no-rdoc --no-ri
